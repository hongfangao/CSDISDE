...
logging.basicConfig(
    level=logging.INFO,
    filename='evaluate_Physio_' + current_time + '.log',
    filemode='w'
)
...
parser.add_argument("--modelfolder", type=str, default="physio_fold0_20250729_090426")
...
logging.info('model folder:{}'.format(foldername))
